...
/**
 * Job: file_delete Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class file_delete implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "file_delete";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(file_delete.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
  ...
  String directory_tFileList_1 = "C:/xampp/htdocs/talend/tmap/delete files";
...
System.out.println(((String)globalMap.get("tFileList_1_CURRENT_FILE")) + " has been deleted!");
 ...
 */
    ...
    public static void main(String[] args){
        final file_delete file_deleteClass = new file_delete();

        int exitCode = file_deleteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = file_delete.class.getClassLoader().getResourceAsStream("tmap/file_delete_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = file_delete.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : file_delete");
        }
...
/************************************************************************************************
 *     35289 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020/02/29 18:55:52 JST
 ************************************************************************************************/