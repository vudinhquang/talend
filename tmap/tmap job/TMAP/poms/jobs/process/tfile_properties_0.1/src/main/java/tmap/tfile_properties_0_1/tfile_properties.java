...
package tmap.tfile_properties_0_1;
...
/**
 * Job: tfile_properties Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class tfile_properties implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "tfile_properties";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				tfile_properties.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(tfile_properties.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TMAP_tfile_properties = new byte[0];
    static byte[] commonByteArray_TMAP_tfile_properties = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TMAP_tfile_properties.length) {
				if(length < 1024 && commonByteArray_TMAP_tfile_properties.length == 0) {
   					commonByteArray_TMAP_tfile_properties = new byte[1024];
				} else {
   					commonByteArray_TMAP_tfile_properties = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TMAP_tfile_properties, 0, length);
			strReturn = new String(commonByteArray_TMAP_tfile_properties, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TMAP_tfile_properties) {
...
public void tFileProperties_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"abs_path","dirname","basename","mode_string","size","mtime","mtime_string",});        
...
java.io.File file_tFileProperties_1 = new java.io.File("C:/xampp/htdocs/talend/tmap/File Properties/imagse.jpg");
row1 = new row1Struct();
...
///////////////////////		
	    		...
	    		if(row1.abs_path != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row1.abs_path)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.dirname != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row1.dirname)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.basename != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.basename)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.mode_string != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row1.mode_string)			
					          ;	
	    		...
	    		if(row1.mtime != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row1.mtime)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.mtime_string != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row1.mtime_string)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final tfile_properties tfile_propertiesClass = new tfile_properties();

        int exitCode = tfile_propertiesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = tfile_properties.class.getClassLoader().getResourceAsStream("tmap/tfile_properties_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = tfile_properties.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tFileProperties_1Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
}catch (TalendException e_tFileProperties_1) {
globalMap.put("tFileProperties_1_SUBPROCESS_STATE", -1);

e_tFileProperties_1.printStackTrace();
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tfile_properties");
        }
...
/************************************************************************************************
 *     41953 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020/02/29 18:57:22 JST
 ************************************************************************************************/