...
/**
 * Job: row_count Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class row_count implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "row_count";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(row_count.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String tmp_tFileRowCount_1 = "C:/xampp/htdocs/talend/tmap/Counting Rows/Album_Names.csv";
...
if (tmp_tFileRowCount_1.toLowerCase().endsWith(".xls")){
  ...
  final jxl.Workbook wb_tFileRowCount_1 = jxl.Workbook.getWorkbook(
      new java.io.BufferedInputStream(
          new java.io.FileInputStream("C:/xampp/htdocs/talend/tmap/Counting Rows/Album_Names.csv")), wbs_tFileRowCount_1);
  ...
  java.io.BufferedReader br_tFileRowCount_1 = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream("C:/xampp/htdocs/talend/tmap/Counting Rows/Album_Names.csv"), "ISO-8859-15"));			
 ...
 */
    ...
    public static void main(String[] args){
        final row_count row_countClass = new row_count();

        int exitCode = row_countClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = row_count.class.getClassLoader().getResourceAsStream("tmap/row_count_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = row_count.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tFileRowCount_1Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
}catch (TalendException e_tFileRowCount_1) {
globalMap.put("tFileRowCount_1_SUBPROCESS_STATE", -1);

e_tFileRowCount_1.printStackTrace();
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : row_count");
        }
...
/************************************************************************************************
 *     32157 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020/02/29 18:56:29 JST
 ************************************************************************************************/